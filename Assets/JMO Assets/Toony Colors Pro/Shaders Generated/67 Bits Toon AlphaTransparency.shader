...
Shader "67 Bits/Toon AlphaTransparency"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha noforwardadd interpolateview halfasview nolightmap nofog nolppv keepalpha
		#pragma instancing_options assumeuniformscaling nolodfade nolightprobe nolightmap
		#pragma target 3.0
